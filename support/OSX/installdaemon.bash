...
echo 'Installing PlexConnect_daemon...'
...
sed -e "s/__REPLACE_THIS_PATH__/${ourpath}/" ./support/OSX/com.plex.plexconnect_daemon.bash.plist > /Library/LaunchDaemons/com.plex.plexconnect_daemon.bash.plist

...
FOLDER2=`echo "$QUERY_STRING" | sed -n 's/^.*folder2=\([^&]*\).*$/\1/p' | sed "s/%20/ /g"| sed "s/%2F/\//g"`
    ...
    echo "<img src="http://alliosnews.com/wp-content/uploads/2011/11/Trailers-Icon-150x150.png">"
    echo "<img src="http://www5.bluevalleyk12.org/tech-fair/wp-content/uploads/2013/09/iMovie-icon-150x150.jpg">"
    echo "<img src="http://www.csuohio.edu/business/osm/resources/news/images/WSJ-icon.jpg">"
    echo "<br>"
...
echo "<img src="https://forums.plex.tv/uploads/monthly_07_2013/post-124968-0-98849800-1373276304.png">"
    echo "<br>"    

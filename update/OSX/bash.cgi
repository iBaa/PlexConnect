...
echo "<input type="image" src="http://www.icon2s.com/wp-content/uploads/2013/01/Button-Delete-icon-150x150.png" name=cmd value=removecetsbash>"
    echo "</p>"  
    echo "PlexConnect commands (Install, Update, Start, Stop, Restart)"
    echo "<br>"
    ...
    echo "<input type="image" src="http://blog.smartadserver.com/wp-content/uploads/2012/11/icon-rm-150x150.png?1c4893" name=cmd value=statusbash>"
    echo "</p>"

...
function scrobbleMenu(type, ratingKey, addrPMS) {
  var xmlstr = '<?xml version="1.0" encoding="UTF-8"?><atv><head><script src="http://trailers.apple.com/js/scrobble.js"/></head> \
...
function selectArtwork(addrPMS, ratingKey) {
  ...
  req.send();
	...
	var xml = '<?xml version="1.0" encoding="UTF-8"?><atv><head><script src="http://trailers.apple.com/js/scrobble.js"/></head> \
